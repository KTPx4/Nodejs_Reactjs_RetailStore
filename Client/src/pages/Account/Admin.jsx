...
import SetStatus from "../../components/Modal/setStatus";
  ...
  const AdminPage = () => {
    ...
    if (loadSuccess) {
      listTBody = <></>;
      const filteredList = LIST_ACCOUNT.filter(acc => acc._id !== currentID??"");
      ...
      (      
        <tr className="text-center" key={acc._id}>
          ...
          <td className="action">
            ...
            href="#" className="btn btn-warning btn-sm">
              {acc.isDeleted && (
                <>
              ...
              <div className="projects mb-4">
                <div className="projects-inner">
                  <header className="projects-header">
                    ...
                    <div className="btn btn-success btn-add-staff btn-header" onClick={()=> setshowAdd(true)}> 
                      Thêm Nhân Viên
                    </div>
